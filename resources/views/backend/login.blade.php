                        ...
                        <form action="{{url('/admin')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-right">
                                    <input type="email" required name="email" id="exampleInputUsername" class="form-control input-shadow"
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative has-icon-right">
                                    <input type="password" required name="password" id="exampleInputPassword" class="form-control input-shadow"
